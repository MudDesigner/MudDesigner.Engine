...
namespace MudDesigner.Engine.Eventing
{
    ...
    public interface IEventDispatcher
    {
        ...
        ISubscription Subscribe<TMessageType>(Action<TMessageType, ISubscription> callback, Func<TMessageType, bool> condition = null) where TMessageType : class, IEvent;
        ...
        void Publish<TMessageType>(TMessageType message) where TMessageType : class, IEvent;
    }
}
