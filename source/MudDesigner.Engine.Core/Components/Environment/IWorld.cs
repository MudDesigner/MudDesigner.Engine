...
namespace MudDesigner.Engine.Components.Environment
{
    ...
    /// </summary>
    public interface IWorld : IGameComponent, ICloneable<IWorld>
    {
        /// <summary>
        ...
        /// </summary>
        ITimePeriodFactory TimePeriodFactory { get; }
        ...
        /// <param name="realms">The realms.</param>
        /// <returns></returns>
        Task AddRealmsToWorld(IRealm[] realms);
        ...
        /// <returns>Returns an awaitable Task</returns>
        Task RemoveRealmsFromWorld(IRealm[] realms);
