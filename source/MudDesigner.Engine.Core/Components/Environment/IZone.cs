...
namespace MudDesigner.Engine.Components.Environment
{
    ...
    public interface IZone : IGameComponent
    {
        ...
        /// </summary>
        IWeatherCondition CurrentWeather { get; }
        ...
        /// <returns>Returns an awaitable Task</returns>
        Task AddRoomsToZone(IRoom[] rooms);
        ...
        /// <returns>Returns an awaitable Task</returns>
        Task RemoveRoomsFromZone(IRoom[] rooms);
        ...
        /// <returns>Returns an awaitable Task</returns>
        Task AddWeatherState(IWeatherCondition weatherState);
        ...
        /// <param name="weatherState">State of the weather.</param>
        /// <returns>Returns an awaitable Task</returns>
        Task RemoveWeatherState(IWeatherCondition weatherState);
