...
{
    internal class LocalEventDispatcher : IEventDispatcher
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LocalEventDispatcher"/> class.
        /// </summary>
        ...
        /// <returns></returns>
        public ISubscription Subscribe<TMessageType>(Action<TMessageType, ISubscription> callback, Func<TMessageType, bool> condition = null) where TMessageType : class, IEvent
        {
            if (callback == null)
            {
